...
func (uko *UkoV4) ListManagedKeyVersionsWithContext(ctx context.Context, listManagedKeyVersionsOptions *ListManagedKeyVersionsOptions) (result *ManagedKeyList, response *core.DetailedResponse, err error) {
	...
	builder.AddHeader("Accept", "application/json")
	if listManagedKeyVersionsOptions.UKOVault != nil {
		builder.AddHeader("UKO-Vault", fmt.Sprint(*listManagedKeyVersionsOptions.UKOVault))
	}
...
func (uko *UkoV4) RotateManagedKey(rotateManagedKeyOptions *RotateManagedKeyOptions) (result *StatusInKeystores, response *core.DetailedResponse, err error) {
...
func (uko *UkoV4) RotateManagedKeyWithContext(ctx context.Context, rotateManagedKeyOptions *RotateManagedKeyOptions) (result *StatusInKeystores, response *core.DetailedResponse, err error) {
	...
	builder.AddHeader("Accept", "application/json")
	if rotateManagedKeyOptions.UKOVault != nil {
		builder.AddHeader("UKO-Vault", fmt.Sprint(*rotateManagedKeyOptions.UKOVault))
	}
...
type CreateKeystoreOptions struct {
	...
	// Do not create a keystore, only verify if keystore created with given parameters can be communciated with
	// successfully.
...
func (*UkoV4) NewListManagedKeyVersionsOptions(id string, uKOVault string) *ListManagedKeyVersionsOptions {
...
// SetUKOVault : Allow user to set UKOVault
func (_options *ListManagedKeyVersionsOptions) SetUKOVault(uKOVault string) *ListManagedKeyVersionsOptions {
	_options.UKOVault = core.StringPtr(uKOVault)
	return _options
}
...
func (_options *ListManagedKeyVersionsOptions) SetSize(size int64) *ListManagedKeyVersionsOptions {
	_options.Size = core.Int64Ptr(size)
	return _options
}

// SetSizeMin : Allow user to set SizeMin
func (_options *ListManagedKeyVersionsOptions) SetSizeMin(sizeMin int64) *ListManagedKeyVersionsOptions {
	_options.SizeMin = core.Int64Ptr(sizeMin)
	return _options
}

// SetSizeMax : Allow user to set SizeMax
func (_options *ListManagedKeyVersionsOptions) SetSizeMax(sizeMax int64) *ListManagedKeyVersionsOptions {
...
func (*UkoV4) NewRotateManagedKeyOptions(id string, uKOVault string, ifMatch string) *RotateManagedKeyOptions {
...
// SetUKOVault : Allow user to set UKOVault
func (_options *RotateManagedKeyOptions) SetUKOVault(uKOVault string) *RotateManagedKeyOptions {
	_options.UKOVault = core.StringPtr(uKOVault)
	return _options
}
