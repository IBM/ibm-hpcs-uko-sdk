		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					Expect(req.URL.Query()["template.name"]).To(Equal([]string{"testString"}))
			...
			It(`Invoke ListManagedKeys with error: Operation response processing error`, func() {
				...
				listManagedKeysOptionsModel.TemplateName = core.StringPtr("testString")
				...
				listManagedKeysOptionsModel.StatusInKeystoresKeystoreSyncFlag = []string{"ok"}
				listManagedKeysOptionsModel.TemplateAlignmentStatus = core.StringPtr("aligned")
				listManagedKeysOptionsModel.KeyMaterialPresent = []string{"repository"}
		...
		Context(`Using mock server endpoint - paginated response`, func() {
			...
			It(`Use ManagedKeysPager.GetNext successfully`, func() {
				...
				listManagedKeysOptionsModel := &ukov4.ListManagedKeysOptions{
					...
					StatusInKeystoresKeystoreSyncFlag: []string{"ok"},
					TemplateAlignmentStatus: core.StringPtr("aligned"),
					KeyMaterialPresent: []string{"repository"},
	...
	Describe(`DeleteManagedKey(deleteManagedKeyOptions *DeleteManagedKeyOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke DeleteManagedKey successfully`, func() {
				...
				deleteManagedKeyOptionsModel.Force = core.BoolPtr(false)
	...
	Describe(`ListManagedKeyVersions(listManagedKeyVersionsOptions *ListManagedKeyVersionsOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListManagedKeyVersions with error: Operation response processing error`, func() {
				...
				listManagedKeyVersionsOptionsModel.TemplateName = core.StringPtr("testString")
				...
				listManagedKeyVersionsOptionsModel.StatusInKeystoresKeystoreSyncFlag = []string{"ok"}
				listManagedKeyVersionsOptionsModel.TemplateAlignmentStatus = core.StringPtr("aligned")
				listManagedKeyVersionsOptionsModel.KeyMaterialPresent = []string{"repository"}
	...
	Describe(`ListManagedKeysFromKeystore(listManagedKeysFromKeystoreOptions *ListManagedKeysFromKeystoreOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke ListManagedKeysFromKeystore with error: Operation response processing error`, func() {
				...
				listManagedKeysFromKeystoreOptionsModel.TemplateName = core.StringPtr("testString")
				...
				listManagedKeysFromKeystoreOptionsModel.StatusInKeystoresKeystoreSyncFlag = []string{"ok"}
				listManagedKeysFromKeystoreOptionsModel.TemplateAlignmentStatus = core.StringPtr("aligned")
				listManagedKeysFromKeystoreOptionsModel.KeyMaterialPresent = []string{"repository"}
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewDeleteManagedKeyOptions successfully`, func() {
				...
				deleteManagedKeyOptionsModel.SetForce(false)
				...
				Expect(deleteManagedKeyOptionsModel.Force).To(Equal(core.BoolPtr(false)))
			...
			It(`Invoke NewListManagedKeyVersionsOptions successfully`, func() {
				...
				listManagedKeyVersionsOptionsModel.SetTemplateName("testString")
				...
				listManagedKeyVersionsOptionsModel.SetStatusInKeystoresKeystoreSyncFlag([]string{"ok"})
				listManagedKeyVersionsOptionsModel.SetTemplateAlignmentStatus("aligned")
				listManagedKeyVersionsOptionsModel.SetKeyMaterialPresent([]string{"repository"})
				...
				Expect(listManagedKeyVersionsOptionsModel.TemplateName).To(Equal(core.StringPtr("testString")))
				...
				Expect(listManagedKeyVersionsOptionsModel.StatusInKeystoresKeystoreSyncFlag).To(Equal([]string{"ok"}))
				Expect(listManagedKeyVersionsOptionsModel.TemplateAlignmentStatus).To(Equal(core.StringPtr("aligned")))
				Expect(listManagedKeyVersionsOptionsModel.KeyMaterialPresent).To(Equal([]string{"repository"}))
			...
			It(`Invoke NewListManagedKeysFromKeystoreOptions successfully`, func() {
				...
				listManagedKeysFromKeystoreOptionsModel.SetTemplateName("testString")
				...
				listManagedKeysFromKeystoreOptionsModel.SetStatusInKeystoresKeystoreSyncFlag([]string{"ok"})
				listManagedKeysFromKeystoreOptionsModel.SetTemplateAlignmentStatus("aligned")
				listManagedKeysFromKeystoreOptionsModel.SetKeyMaterialPresent([]string{"repository"})
				...
				Expect(listManagedKeysFromKeystoreOptionsModel.TemplateName).To(Equal(core.StringPtr("testString")))
				...
				Expect(listManagedKeysFromKeystoreOptionsModel.StatusInKeystoresKeystoreSyncFlag).To(Equal([]string{"ok"}))
				Expect(listManagedKeysFromKeystoreOptionsModel.TemplateAlignmentStatus).To(Equal(core.StringPtr("aligned")))
				Expect(listManagedKeysFromKeystoreOptionsModel.KeyMaterialPresent).To(Equal([]string{"repository"}))
			...
			It(`Invoke NewListManagedKeysOptions successfully`, func() {
				...
				listManagedKeysOptionsModel.SetTemplateName("testString")
				...
				listManagedKeysOptionsModel.SetStatusInKeystoresKeystoreSyncFlag([]string{"ok"})
				listManagedKeysOptionsModel.SetTemplateAlignmentStatus("aligned")
				listManagedKeysOptionsModel.SetKeyMaterialPresent([]string{"repository"})
				...
				Expect(listManagedKeysOptionsModel.TemplateName).To(Equal(core.StringPtr("testString")))
				...
				Expect(listManagedKeysOptionsModel.StatusInKeystoresKeystoreSyncFlag).To(Equal([]string{"ok"}))
				Expect(listManagedKeysOptionsModel.TemplateAlignmentStatus).To(Equal(core.StringPtr("aligned")))
				Expect(listManagedKeysOptionsModel.KeyMaterialPresent).To(Equal([]string{"repository"}))
